import { User, Cpu, Scroll } from "lucide-react";
...
export default function BottomNav({ activeTab, onTabChange, activeMissionCount }: BottomNavProps) {
  const tabs: TabItem[] = [
    { id: "frontier", label: "FRONTIER", icon: ChessKnight, isCustom: true },
    { id: "hasex", label: "MAVERICK", icon: Cpu, isCustom: false },
    { id: "journal", label: "CHRONICLE", icon: Scroll, isCustom: false },
    { id: "profile", label: "PROFILE", icon: User, isCustom: false }
  ];
